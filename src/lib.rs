...
impl Rotation {
    pub fn new(dim: usize, seed: u64) -> Self {
        ...
        // two bits: PVQ +5.5 and E8 +2.5 Recall@10 points, the trellis +0.4. It is
        // adopted because it is the better transform, not because it favours us --
        // it narrows the trellis's lead over the field from 5.7 to 5.1 points.
        // Beyond three the gain reverses (four rounds is worse than three).
